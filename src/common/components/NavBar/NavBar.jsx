      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters sx={{ py: 1 }}>
          <Box sx={{ display: { xs: 'none', md: 'flex' }, alignItems: 'center', mr: 2 }}>
            ...
            <Box sx={{ textAlign: 'left' }}>
              <Typography variant="h6" noWrap component="a" href="/" sx={{ mr: 2, display: 'block', fontFamily: 'serif', fontWeight: 700, letterSpacing: '.05rem', color: 'inherit', textDecoration: 'none', lineHeight: 1.2 }}>
                {logoText}
              </Typography>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            <IconButton size="large" aria-label="open drawer" edge="start" onClick={handleDrawerToggle} color="inherit">
              <MenuIcon />
            </IconButton>
          </Box>

          <Box sx={{ display: { xs: 'flex', md: 'none' }, flexGrow: 1, alignItems: 'center' }}>
             <Box sx={{ border: '1px solid rgba(255, 255, 255, 0.5)', borderRadius: '50%', p: 0.5, mr: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <LogoIcon sx={{ color: 'white', fontSize: '1.2rem' }} />
            </Box>
            <Box sx={{ textAlign: 'left' }}>
              <Typography variant="subtitle1" noWrap component="a" href="/" sx={{ display: 'block', fontFamily: 'serif', fontWeight: 700, color: 'inherit', textDecoration: 'none', lineHeight: 1.1 }}>
                {logoText}
              </Typography>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' }, justifyContent: 'flex-end', mr: 4 }}>
            {pages.map((page) => (
              <MuiButton key={page.label} component="a" href={page.path} sx={{ my: 2, color: 'white', display: 'block', textTransform: 'none', fontSize: { md: '0.95rem', lg: '1rem', xl: '1.1rem' }, mx: { md: 1, lg: 1.5, xl: 2 }, '&:hover': { color: '#EAB252', backgroundColor: 'transparent' } }}>
                {page.label}
              </MuiButton>
            ))}
          </Box>
